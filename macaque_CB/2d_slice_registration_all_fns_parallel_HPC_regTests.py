...
output_dir = f'/tmp/slice_reg_perSliceTemplate_image_weights_dwnsmple_parallel_v2_{rescale}_short/'
...
for iter in range(num_reg_iterations): 
    ...
    slice_offset_list_forward = [-1,1] 
    slice_offset_list_reverse = [-2,2] 
