...
output_dir = f'/tmp/slice_reg_perSliceTemplate_image_weights_dwnsmple_parallel_v2_{rescale}_casc_v5/'
...
def run_cascading_coregistrations(output_dir, subject, all_image_fnames, anchor_slice_idx = None,
                                  ...
                                  reg_level_tag='coreg1nl', previous_target_tag=None, run_syn=True):
    """
