...
def coreg_multislice(output_dir,subject,all_image_fnames,template,target_slice_offet_list=[-1,-2,-3], 
                     zfill_num=4, previous_reg_level_tag='coreg0nl', reg_level_tag='coreg1nl'):
     ...
     for idx,img in enumerate(all_image_fnames):
        ...
        # current image
        previous_tail = f'_{previous_reg_level_tag}_ants-def0.nii.gz'
...
def coreg_multislice_reverse(output_dir,subject,all_image_fnames,template,target_slice_offet_list=[1,2,3], 
                             zfill_num=4, previous_reg_level_tag='coreg1nl', reg_level_tag='coreg2nl'):
     ''' Co-register to slices before/after
     target_offset_list: negative values indicate slices prior to the current, positive after
...
template = generate_stack_and_template(output_dir,subject,all_image_fnames,zfill_num=4,reg_level_tag='coreg121nl')

#backwards registration
coreg_multislice_reverse(output_dir,subject,all_image_fnames,template,target_slice_offet_list=[1,2,3], zfill_num=zfill_num, previous_reg_level_tag='coreg121nl', reg_level_tag='coreg122nl') 
template = generate_stack_and_template(output_dir,subject,all_image_fnames,zfill_num=4,reg_level_tag='coreg122nl')

#select best of the previous two regs and update registrations
select_best_reg_by_MI(output_dir,subject,all_image_fnames,template_tag='coreg12nl',zfill_num=zfill_num,reg_level_tag1='coreg121nl', reg_level_tag2='coreg122nl',reg_output_tag='coreg1212nl')
template = generate_stack_and_template(output_dir,subject,all_image_fnames,zfill_num=4,reg_level_tag='coreg1212nl')


## ****************************** Iteration 3
# forwards registration
coreg_multislice(output_dir,subject,all_image_fnames,template,target_slice_offet_list=[-1,-2,-3], zfill_num=zfill_num, previous_reg_level_tag='coreg1212nl', reg_level_tag='coreg12121nl') 
template = generate_stack_and_template(output_dir,subject,all_image_fnames,zfill_num=4,reg_level_tag='coreg12121nl')

#backwards registration
coreg_multislice_reverse(output_dir,subject,all_image_fnames,template,target_slice_offet_list=[1,2,3], zfill_num=zfill_num, previous_reg_level_tag='coreg12121nl', reg_level_tag='coreg12122nl') 
template = generate_stack_and_template(output_dir,subject,all_image_fnames,zfill_num=4,reg_level_tag='coreg122nl')

#select best of the previous two regs and update registrations
select_best_reg_by_MI(output_dir,subject,all_image_fnames,template_tag='coreg1212nl',zfill_num=zfill_num,reg_level_tag1='coreg12121nl', reg_level_tag2='coreg12122nl',reg_output_tag='coreg121212nl')
template = generate_stack_and_template(output_dir,subject,all_image_fnames,zfill_num=4,reg_level_tag='coreg121212nl')