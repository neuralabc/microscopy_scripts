...
rescale=20 #larger scale means that you have to change the scaling_factor
...
all_images_fnames = list(_df['file_name'].values)
...
scaling_factor = 16 #32 or 64 for full?
# STEP 1: Rigid + Syn
